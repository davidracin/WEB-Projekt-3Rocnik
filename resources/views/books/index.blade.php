...
<div class="bg-primary text-white p-5 rounded-3 mb-5 shadow">
    ...
    <div class="row">        <!-- Sidebar with filters -->
        ...
        </div><!-- Main content with book list -->
    <div class="col-lg-9">
        ...
        @if($books->isEmpty())
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                @foreach($books as $book)                    <div class="col">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center rating-stars">
                                                <!-- This would be replaced with actual rating data -->
            ...
            <!-- Featured section or newsletter -->
            <div class="mt-5 pt-4 border-top">
                <h3 class="text-center mb-4">Chcete být informováni o nových knihách?</h3>
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form class="d-flex">
                            <input class="form-control me-2" type="email" placeholder="Váš e-mail" aria-label="Email">
